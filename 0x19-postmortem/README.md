...
Bug debugger Brennan (BDB... as in my actual initials... made that up on the spot, fair enough right?) encountered the issue upon opening the project and being, well, instructed to
...
the server. Expected something wonderful but oh no!, it got disappointed. `strace` gave no useful
information.
...
[0-strace_is_your_friend.pp](https://github.com/UfiairENE/alx-system_engineering-devops/blob/main/0x17-web_stack_debugging_3/0-strace_is_your_friend.pp)
to automate fixing of any such identitical errors should they occur in the future. The manifest
replaces any `phpp` extensions in the file `/var/www/html/wp-settings.php` with `php`.

But of course, it will never occur again, because we're programmers, we fix what is broken everytime! :wink:
